...
img1 = cv2.imread("C:\\Users\\faube\\Desktop\\Python\\Data\\Maze_originalfinal.jpg", cv2.IMREAD_GRAYSCALE)

#Calculate Barrier and new Map
class Point(object):
...
img1 = cv2.rectangle(img1, (currentx-10 ,currenty),(currentx + 10, currenty), (0, 0, 0), 5)

vis = np.concatenate((img,img1), axis=1)
cv2.imwrite('C:\\Users\\faube\\Desktop\\Python\\Data\\Maze_barrier.jpg',img1)
cv2.imshow('Alte und Neue Map',vis)
cv2.waitKey(0)
...
img = cv2.imread("C:\\Users\\faube\\Desktop\\Python\\Data\\Maze_barrier.jpg", cv2.IMREAD_GRAYSCALE)
